...
class Pedido(Base):
    ...
    original_cache_path = Column(String, nullable=True)  # URL de la previsualización en la nube
...
class Diseno(Base):
    ...
    design_cache_path = Column(String, nullable=True)  # URL de la previsualización en la nube
